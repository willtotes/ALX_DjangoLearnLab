...
urlpatterns = [
    ...
    path('books/update/', views.BookUpdateView.as_view(), name='books-update-simple'),
    ...
    path('authors-combined/', views.AuthorListCreateView.as_view(), name='author-list-create'),
